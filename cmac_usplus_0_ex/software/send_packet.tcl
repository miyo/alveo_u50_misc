...
set_property OUTPUT_VALUE 0 [get_hw_probes user_kick -of_objects [get_hw_vios -of_objects [get_hw_devices xcu50_0] -filter {CELL_NAME=~"vio_0_i"}]]
commit_hw_vio [get_hw_probes {user_kick} -of_objects [get_hw_vios -of_objects [get_hw_devices xcu50_0] -filter {CELL_NAME=~"vio_0_i"}]]
set_property OUTPUT_VALUE 1 [get_hw_probes user_kick -of_objects [get_hw_vios -of_objects [get_hw_devices xcu50_0] -filter {CELL_NAME=~"vio_0_i"}]]
commit_hw_vio [get_hw_probes {user_kick} -of_objects [get_hw_vios -of_objects [get_hw_devices xcu50_0] -filter {CELL_NAME=~"vio_0_i"}]]
quit
